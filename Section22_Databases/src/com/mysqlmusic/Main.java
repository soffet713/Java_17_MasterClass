...
public class Main {
	...
	public static void main(String[] args) {
		...
		dataSource.setDatabaseName("music");	// different ways of setting values for dataSource variable to use
												// in try-with-resources clause below
