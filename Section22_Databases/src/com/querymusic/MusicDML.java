...
public class MusicDML {
	...
	public static void main(String[] args) {
		...
		try (Connection connection = DriverManager.getConnection(
			...
			String[] songList = {"You're No Good","Talkin' New York","In My Time of Dyin'","Man of Constant Sorrow",
			"Fixin' to Die","Pretty Peggy-O","Highway 51","Gospel Plow","Baby, Let Me Follow You Down",
			...
			if (!executeSelect(statement, tableName, columnName, columnValue)) {
				...
				insertArtistAlbum(statement, columnValue, columnValue, songList);
			} else {
	...
	private static boolean updateRecord(Statement statement, String table, String matchedColumn, String matchedValue,
										String updatedName, String updatedValue) throws SQLException {

		String query = "UPDATE %s SET %s = '%s' WHERE %s='%s'".formatted(table,updatedName,updatedValue,
	...
	private static void insertArtistAlbum(Statement statement, String artistName, String albumName, String[] songs)
		throws SQLException {
		...
		statement.execute(artistInsert, Statement.RETURN_GENERATED_KEYS); //return generated key if artist is inserted
