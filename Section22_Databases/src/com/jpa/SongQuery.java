...
import com.jpa.music.Album;
import com.jpa.music.Artist;
import com.jpa.music.Song;
...
public class SongQuery {
	...
	public static void main(String[] args) {
		...
		try (EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.jpa.music");
			...
			var bmatches = getSongsBuilder(em, "%" + word + "%");
			bmatches.forEach(m ->
	...
	public static List<Artist> getMatchedSongs(EntityManager em, String matchedValue) {

		String jpql = "SELECT a FROM Artist a JOIN albums album join songList s WHERE s.songTitle LIKE ?1";
		var query = em.createQuery(jpql, Artist.class);
		query.setParameter(1, matchedValue);
		return query.getResultList();
	}

	private static List<Object[]> getSongsBuilder(EntityManager em, String matchedValue) {
		...
		Join<Album, Song> songJoin = albumJoin.join("songList", JoinType.INNER);
