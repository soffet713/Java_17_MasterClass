...
public class CoursePirate implements CoursePlayer {
    private final String name;
    private final Map<String,Integer> gameData;
    private final List<String> townsVisited = new LinkedList<>();
    private CourseWeapon currentWeapon;

    public CoursePirate(String name) {
        this.name = name;
    }
    ...
    public CourseWeapon getCurrentWeapon() {
        return currentWeapon;
    }

    void setCurrentWeapon(CourseWeapon currentWeapon) {
    ...
    boolean visitTown() {
        ...
        List<String> levelTowns = CoursePirateGame.getTowns(value("level"));
    ...
    private boolean visitNextTown() {
        ...
        var towns = CoursePirateGame.getTowns(value("level"));
