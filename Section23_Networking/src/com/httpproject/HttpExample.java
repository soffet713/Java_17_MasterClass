...
public class HttpExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			connection.setRequestMethod("GET"); // GET is the default request method, so technically don't have to specify it here
			//connection.setRequestMethod("POST");
			connection.setRequestProperty("User-Agent","Chrome");
			connection.setRequestProperty("Accept", "application/json, application/html");
			connection.setReadTimeout(30000); // this is generous. Probably 10 or 15 seconds would be reasonable
