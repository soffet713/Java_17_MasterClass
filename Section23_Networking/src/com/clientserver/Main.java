...
public class Main {
	...
	public static void main(String[] args) {
		...
		//doOperation("2. Change the limit to capacity: ", buffer, (b) -> b.limit(b.capacity()));\
		doOperation("Compact: ", buffer, ByteBuffer::compact); // compact does the same as the two steps above
	...
	private static void doOperation(String op, ByteBuffer buffer, Consumer<ByteBuffer> c) {
		...
		c.accept(buffer);
		System.out.printf("Capacity = %d, Limit = %d, Position = %d, Remaining = %d%n", buffer.capacity(),
