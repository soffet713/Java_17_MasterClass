...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String,String> lastName = s -> s.concat(" Kittle");
        ...
        String[] names = {"Paul","David","Matthew","John","Amanda"};
        Consumer<String> s0 = s -> System.out.print(s.charAt(0));
        Consumer<String> s1 = System.out::println;

        Arrays.asList(names).forEach(s0.andThen(s -> System.out.print(" - ")).andThen(s1));

        Predicate<String> p1 = s -> s.equals("GEORGE");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("George");
