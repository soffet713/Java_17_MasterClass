...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> nameList = new ArrayList<>(List.of("John","David","Matthew","Paul","Sarah","Emily",
                "Brittney","Martin","Connor","Sam","Michelle","Abigail","Jessica","Mark","Freddie","Laura","Alex",
                "Scott","Megan","Natasha"));
