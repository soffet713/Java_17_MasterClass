    ...
    public static void main(String[] args) {
        ...
        for(char c : "BINGO".toCharArray()) {
            for(int i=start; i < (start + 15); i++) {
                if(i<10) { bingoPool.add(c + "0" + i); }
                else { bingoPool.add("" + c + i); }
        ...
        var secondStream = Stream.of("Six", "Five", "Four")
                .map(String::toUpperCase); //similar to replaceAll method
                //.forEach(System.out::println);
        ...
        System.out.println("\n" + "-".repeat(75));
        IntStream.range(1, 100) //100 is exclusive
                .filter(Main::isPrime)
                .forEach(s -> System.out.print(s + " "));

        System.out.println("\n" + "-".repeat(75));
        IntStream.rangeClosed(1, 100) //100 is inclusive
                .filter(Main::isPrime)
                .forEach(s -> System.out.print(s + " "));
    }
