...
public class Main {
	...
	public static void main(String[] args) {
		...
		String[] firsts = {"John","Adam","Joseph","Mary","Sarah","David","Chelsea"};

		AtomicStudentId idGenerator = new AtomicStudentId();
		Callable<Student> studentMaker = () -> {
			int studentId = idGenerator.getNextId();
			//Student student = new Student(firsts[rand.nextInt(firsts.length-1)] + " " + studentId,
			//		rand.nextInt(2017,2025), studentId);
			Student student = new Student("John " + studentId, rand.nextInt(2017,2025), studentId);
